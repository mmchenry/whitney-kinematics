...
% This is a modified version of an example created by Mathworks.
%
...
function multiObjectTracking(vid_file,startFrame)

% Create System objects used for reading video, detecting moving objects,
% and displaying the results.
obj = setupSystemObjects();

% % Loop thru frames before startFrame
...
% foreground objects, and displaying results.
    ...
    function obj = setupSystemObjects()
        ...
        obj.reader = vision.VideoFileReader(vid_file);
        
        % Create two video players, one to display the video,
        % and one to display the foreground mask.
%         obj.videoPlayer = vision.VideoPlayer('Position', [20, 400, 700, 400]);
%         obj.maskPlayer = vision.VideoPlayer('Position', [740, 400, 700, 400]);
        obj.videoPlayer = vision.VideoPlayer('Position', [0, 728, 1350, 800]);
        obj.maskPlayer = vision.VideoPlayer('Position', [0, 5, 1351, 681]);
...
%         
%         % Undistort for lens
%         [frame, newOrigin] = undistortImage(frame, lensParams);
%         
...
%         
%         % Define mask
%         BW = poly2mask(roi(:,1),roi(:,2),size(frame,1),size(frame,2));
%         
